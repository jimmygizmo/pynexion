...
# For a better development workflow in which we reduce the need to re-create the venv, we will
# install this project's package using the -e option so that pip will install it into the venv
# using symlinks. In this way, changes will be picked up upon each new execution using the module.
#python3 -m pip install -e .  # TODO: Enable this once we have create a module for this project.
